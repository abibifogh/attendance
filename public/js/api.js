...
export const api = {
  ...
  recQuestions: () => request('/api/rec/questions'),
  recSaveQuestions: (id, body) => request(`/api/rec/questions${id ? `/${id}` : ''}`, { method: 'POST', body }),
  recStandardQuestions: () => request('/api/rec/questions/standard', { method: 'POST', body: {} }),
  recRemoveQuestions: (id) => request(`/api/rec/questions/${id}/remove`, { method: 'POST', body: {} }),
  ...
  myOpenPayslips: (code) => request('/api/me/payslip-open', { method: 'POST', body: { code } }),
  myShutPayslips: () => request('/api/me/payslip-shut', { method: 'POST', body: {} }),
  ...
  payrollSeverance: (body) => request('/api/payroll/severance', { method: 'POST', body }),
  payrollRemoveSeverance: (id) => request(`/api/payroll/severance/${id}`, { method: 'DELETE' }),
